    ...
    public static void load(){
       ...
       groundReconstructor = new Reconstructor("ground-reconstructor"){{
        ...
        exponentialReconstructor = new Reconstructor("exponential-reconstructor"){{
            requirements(Category.units, with(Items.lead, 1500, Items.silicon, 750, Items.titanium, 1000, Items.thorium, 750, Items.plastanium, 150));

            size = 7;
            consumePower(10f);
            consumeItems(with(Items.silicon, 580, Items.titanium, 550, Items.plastanium, 420));
        ...
        tetrativeReconstructor = new Reconstructor("tetrative-reconstructor"){{
            requirements(Category.units, with(Items.lead, 3000, Items.silicon, 2500, Items.thorium, 1250, Items.plastanium, 650, Items.phaseFabric, 500, Items.surgeAlloy, 500));
